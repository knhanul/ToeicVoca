  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] pb-24">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-sm text-blue-100 font-medium">프로필 설정</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-white/20 rounded-xl shadow-sm border border-white/30 backdrop-blur-sm hover:bg-white/30 transition-all text-white font-medium"
            >
              <LogOut size={18} />
              <span>로그아웃</span>
            </button>
      ...
      <div className="px-6 mt-6">
        ...
        {/* Tabs */}
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-sm border border-gray-100 mb-6">
          <div className="flex border-b border-gray-100">
            <button
              onClick={() => setActiveTab("profile")}
              className={`flex-1 py-4 px-6 text-center font-medium transition-all rounded-tl-3xl ${
                activeTab === "profile"
            ...
            <button
              ...
              className={`flex-1 py-4 px-6 text-center font-medium transition-all rounded-tr-3xl ${
                activeTab === "password"
                  ? "text-blue-600 bg-blue-50 border-b-2 border-blue-600"
                  : "text-gray-600 hover:text-gray-800 hover:bg-gray-50"
              }`}
          ...
          <div className="p-6">
            ...
            {activeTab === "profile" && (
              <div className="p-6 space-y-6">
                <div className="flex items-center justify-center mb-8">
                  <div className="w-28 h-28 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white text-4xl font-bold shadow-xl border-4 border-white">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-5 rounded-2xl border border-green-100">
                    ...
                    <div className="flex items-center text-gray-900">
                      ...
                      <span className="text-lg font-medium">{user.email || `${user.username}@example.com`}</span>
                    </div>
                  </div>
            ...
            {activeTab === "email" && (
              <form onSubmit={handleEmailUpdate} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-4 rounded-2xl hover:from-blue-700 hover:to-indigo-700 transition-all font-medium shadow-lg shadow-blue-500/25 active:scale-[0.98]"
                >
                  이메일 주소 변경
                </button>
              </form>
